...
function AddListModal({ onAdd, onClose }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    if (name.trim()) {
      onAdd({ name: name.trim(), month: month || null, location })
    }
  }
        ...
        <form className="modal-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <div className="location-options">
              <button
                type="button"
                className={`location-btn ${location === 'casa' ? 'active' : ''}`}
              ...
              <button
                type="button"
                className={`location-btn ${location === 'jacira' ? 'active' : ''}`}
                onClick={() => setLocation('jacira')}
              >
                🏡 Jacira
              </button>
            </div>
